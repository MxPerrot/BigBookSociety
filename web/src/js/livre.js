            ...
            if (book) {
                ...
                bookContainer.innerHTML = `
                    ...
                    <div class="card-content">
                        ...
                        <h3 class="card-author"> ${book[0].nom_auteur || "Auteur inconnu"}</h3>
                        <p class="card-description"> ${book[0].description || "Description non disponible"}</p>
                        <h4 class="card-editeur">Edition: ${book[0].nom_editeur || "Éditeur inconnu"}</h4>
                        <h4 class="card-pages">Pages: ${book[0].nombre_pages || "Nombre de pages inconnu"}</h4>
                        <h4 class="card-datesortie">Date de sortie: ${book[0].date_publication || "Non disponible"}</h4>
                    </div>
